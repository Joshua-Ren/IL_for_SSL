...
def parse():
    ...
    if args.dataset.lower()=='cifar10':
        tmp_kfp=[10, 32, 32, 4, 1] # k_clas, fill_size, fig_size, patch_size, ds_ratio
    elif args.dataset.lower()=='cifar100':
        tmp_kfp=[100, 32, 32, 4, 1]
    else:
...
def main():
    ...
    mae = my_MAE(encoder=encoder, masking_ratio=0, decoder_dim=args.dec_dim, decoder_depth=args.dec_depth)
    mae.cuda()
    if not args.scratch:
